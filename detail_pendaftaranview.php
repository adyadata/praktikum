...
$detail_pendaftaran_view = NULL; // Initialize page object first

class cdetail_pendaftaran_view extends cdetail_pendaftaran {
	...
	// Page object name
	var $PageObjName = 'detail_pendaftaran_view';
	...
	function __construct() {
		...
		if (@$_GET["id_detailpendaftaran"] <> "") {
			$this->RecKey["id_detailpendaftaran"] = $_GET["id_detailpendaftaran"];
			$KeyUrl .= "&amp;id_detailpendaftaran=" . urlencode($this->RecKey["id_detailpendaftaran"]);
		}
	...
	function Page_Init() {
		...
		if (@$_GET["id_detailpendaftaran"] <> "") {
			...
			$gsExportFile .= ew_StripSlashes($_GET["id_detailpendaftaran"]);
		}
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			...
			} elseif (@$_POST["id_detailpendaftaran"] <> "") {
				$this->id_detailpendaftaran->setFormValue($_POST["id_detailpendaftaran"]);
				$this->RecKey["id_detailpendaftaran"] = $this->id_detailpendaftaran->FormValue;
			} else {
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					...
					if (!$bMatchRecord) {
						if ($this->getSuccessMessage() == "" && $this->getFailureMessage() == "")
							$this->setFailureMessage($Language->Phrase("NoRecord")); // Set no record message
						$sReturnUrl = "detail_pendaftaranlist.php"; // No matching record, return to list
					} else {
			...
			$sReturnUrl = "detail_pendaftaranlist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($detail_pendaftaran_view)) $detail_pendaftaran_view = new cdetail_pendaftaran_view();

// Page init
$detail_pendaftaran_view->Page_Init();

// Page main
$detail_pendaftaran_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$detail_pendaftaran_view->Page_Render();
?>
...
var CurrentForm = fdetail_pendaftaranview = new ew_Form("fdetail_pendaftaranview", "view");

// Form_CustomValidate event
fdetail_pendaftaranview.Form_CustomValidate = 
...
fdetail_pendaftaranview.ValidateRequired = true;
<?php } else { ?>
fdetail_pendaftaranview.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
fdetail_pendaftaranview.Lists["x_fk_jenis_praktikum"] = {"LinkField":"x_kode_praktikum","Ajax":true,"AutoFill":false,"DisplayFields":["x_jenis_praktikum","x_semester","x_biaya",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"praktikum"};
fdetail_pendaftaranview.Lists["x_status_praktikum"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fdetail_pendaftaranview.Lists["x_status_praktikum"].Options = <?php echo json_encode($detail_pendaftaran->status_praktikum->Options()) ?>;
fdetail_pendaftaranview.Lists["x_id_kelompok"] = {"LinkField":"x_id_kelompok","Ajax":true,"AutoFill":false,"DisplayFields":["x_nama_kelompok","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"master_nama_kelompok"};
fdetail_pendaftaranview.Lists["x_id_jam_prak"] = {"LinkField":"x_id_jam_praktikum","Ajax":true,"AutoFill":false,"DisplayFields":["x_jam_praktikum","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"master_jam_praktikum"};
fdetail_pendaftaranview.Lists["x_id_lab"] = {"LinkField":"x_id_lab","Ajax":true,"AutoFill":false,"DisplayFields":["x_nama_lab","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"master_lab"};
fdetail_pendaftaranview.Lists["x_id_pngjar"] = {"LinkField":"x_kode_pengajar","Ajax":true,"AutoFill":false,"DisplayFields":["x_nama_pngajar","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"master_pengajar"};
fdetail_pendaftaranview.Lists["x_id_asisten"] = {"LinkField":"x_kode_asisten","Ajax":true,"AutoFill":false,"DisplayFields":["x_nama_asisten","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"master_asisten_pengajar"};
fdetail_pendaftaranview.Lists["x_status_kelompok[]"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fdetail_pendaftaranview.Lists["x_status_kelompok[]"].Options = <?php echo json_encode($detail_pendaftaran->status_kelompok->Options()) ?>;
fdetail_pendaftaranview.Lists["x_nilai_akhir"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fdetail_pendaftaranview.Lists["x_nilai_akhir"].Options = <?php echo json_encode($detail_pendaftaran->nilai_akhir->Options()) ?>;
fdetail_pendaftaranview.Lists["x_persetujuan"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fdetail_pendaftaranview.Lists["x_persetujuan"].Options = <?php echo json_encode($detail_pendaftaran->persetujuan->Options()) ?>;
...
<?php if ($detail_pendaftaran->Export == "") { ?>
<div class="ewToolbar">
<?php if (!$detail_pendaftaran_view->IsModal) { ?>
<?php if ($detail_pendaftaran->Export == "") { ?>
<?php $Breadcrumb->Render(); ?>
<?php } ?>
<?php } ?>
<?php $detail_pendaftaran_view->ExportOptions->Render("body") ?>
<?php
	foreach ($detail_pendaftaran_view->OtherOptions as &$option)
		$option->Render("body");
?>
<?php if (!$detail_pendaftaran_view->IsModal) { ?>
<?php if ($detail_pendaftaran->Export == "") { ?>
...
<?php } ?>
<?php $detail_pendaftaran_view->ShowPageHeader(); ?>
<?php
$detail_pendaftaran_view->ShowMessage();
?>
<?php if (!$detail_pendaftaran_view->IsModal) { ?>
<?php if ($detail_pendaftaran->Export == "") { ?>
<form name="ewPagerForm" class="form-inline ewForm ewPagerForm" action="<?php echo ew_CurrentPage() ?>">
<?php if (!isset($detail_pendaftaran_view->Pager)) $detail_pendaftaran_view->Pager = new cPrevNextPager($detail_pendaftaran_view->StartRec, $detail_pendaftaran_view->DisplayRecs, $detail_pendaftaran_view->TotalRecs) ?>
<?php if ($detail_pendaftaran_view->Pager->RecordCount > 0 && $detail_pendaftaran_view->Pager->Visible) { ?>
<div class="ewPager">
<span><?php echo $Language->Phrase("Page") ?>&nbsp;</span>
<div class="ewPrevNext"><div class="input-group">
<div class="input-group-btn">
<!--first page button-->
	<?php if ($detail_pendaftaran_view->Pager->FirstButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerFirst") ?>" href="<?php echo $detail_pendaftaran_view->PageUrl() ?>start=<?php echo $detail_pendaftaran_view->Pager->FirstButton->Start ?>"><span class="icon-first ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerFirst") ?>"><span class="icon-first ewIcon"></span></a>
	<?php } ?>
<!--previous page button-->
	<?php if ($detail_pendaftaran_view->Pager->PrevButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerPrevious") ?>" href="<?php echo $detail_pendaftaran_view->PageUrl() ?>start=<?php echo $detail_pendaftaran_view->Pager->PrevButton->Start ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerPrevious") ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } ?>
</div>
<!--current page number-->
	<input class="form-control input-sm" type="text" name="<?php echo EW_TABLE_PAGE_NO ?>" value="<?php echo $detail_pendaftaran_view->Pager->CurrentPage ?>">
<div class="input-group-btn">
<!--next page button-->
	<?php if ($detail_pendaftaran_view->Pager->NextButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerNext") ?>" href="<?php echo $detail_pendaftaran_view->PageUrl() ?>start=<?php echo $detail_pendaftaran_view->Pager->NextButton->Start ?>"><span class="icon-next ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerNext") ?>"><span class="icon-next ewIcon"></span></a>
	<?php } ?>
<!--last page button-->
	<?php if ($detail_pendaftaran_view->Pager->LastButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerLast") ?>" href="<?php echo $detail_pendaftaran_view->PageUrl() ?>start=<?php echo $detail_pendaftaran_view->Pager->LastButton->Start ?>"><span class="icon-last ewIcon"></span></a>
	<?php } else { ?>
...
<span>&nbsp;<?php echo $Language->Phrase("of") ?>&nbsp;<?php echo $detail_pendaftaran_view->Pager->PageCount ?></span>
</div>
<?php } ?>
<div class="clearfix"></div>
</form>
<?php } ?>
<?php } ?>
<form name="fdetail_pendaftaranview" id="fdetail_pendaftaranview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($detail_pendaftaran_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $detail_pendaftaran_view->Token ?>">
<?php } ?>
...
<?php echo $detail_pendaftaran->fk_kodedaftar->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($detail_pendaftaran->fk_jenis_praktikum->Visible) { // fk_jenis_praktikum ?>
	<tr id="r_fk_jenis_praktikum">
		<td><span id="elh_detail_pendaftaran_fk_jenis_praktikum"><?php echo $detail_pendaftaran->fk_jenis_praktikum->FldCaption() ?></span></td>
...
<?php echo $detail_pendaftaran->fk_jenis_praktikum->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($detail_pendaftaran->biaya_bayar->Visible) { // biaya_bayar ?>
	<tr id="r_biaya_bayar">
		<td><span id="elh_detail_pendaftaran_biaya_bayar"><?php echo $detail_pendaftaran->biaya_bayar->FldCaption() ?></span></td>
...
<?php echo $detail_pendaftaran->biaya_bayar->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($detail_pendaftaran->tgl_daftar_detail->Visible) { // tgl_daftar_detail ?>
	<tr id="r_tgl_daftar_detail">
		<td><span id="elh_detail_pendaftaran_tgl_daftar_detail"><?php echo $detail_pendaftaran->tgl_daftar_detail->FldCaption() ?></span></td>
...
<?php echo $detail_pendaftaran->tgl_daftar_detail->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($detail_pendaftaran->jam_daftar_detail->Visible) { // jam_daftar_detail ?>
	<tr id="r_jam_daftar_detail">
		<td><span id="elh_detail_pendaftaran_jam_daftar_detail"><?php echo $detail_pendaftaran->jam_daftar_detail->FldCaption() ?></span></td>
...
<?php echo $detail_pendaftaran->jam_daftar_detail->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($detail_pendaftaran->status_praktikum->Visible) { // status_praktikum ?>
	<tr id="r_status_praktikum">
		<td><span id="elh_detail_pendaftaran_status_praktikum"><?php echo $detail_pendaftaran->status_praktikum->FldCaption() ?></span></td>
...
<?php echo $detail_pendaftaran->status_praktikum->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($detail_pendaftaran->id_kelompok->Visible) { // id_kelompok ?>
	<tr id="r_id_kelompok">
		<td><span id="elh_detail_pendaftaran_id_kelompok"><?php echo $detail_pendaftaran->id_kelompok->FldCaption() ?></span></td>
...
<?php echo $detail_pendaftaran->id_kelompok->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($detail_pendaftaran->id_jam_prak->Visible) { // id_jam_prak ?>
	<tr id="r_id_jam_prak">
		<td><span id="elh_detail_pendaftaran_id_jam_prak"><?php echo $detail_pendaftaran->id_jam_prak->FldCaption() ?></span></td>
...
<?php echo $detail_pendaftaran->id_jam_prak->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($detail_pendaftaran->id_lab->Visible) { // id_lab ?>
	<tr id="r_id_lab">
		<td><span id="elh_detail_pendaftaran_id_lab"><?php echo $detail_pendaftaran->id_lab->FldCaption() ?></span></td>
...
<?php echo $detail_pendaftaran->id_lab->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($detail_pendaftaran->id_pngjar->Visible) { // id_pngjar ?>
	<tr id="r_id_pngjar">
		<td><span id="elh_detail_pendaftaran_id_pngjar"><?php echo $detail_pendaftaran->id_pngjar->FldCaption() ?></span></td>
...
<?php echo $detail_pendaftaran->id_pngjar->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($detail_pendaftaran->id_asisten->Visible) { // id_asisten ?>
	<tr id="r_id_asisten">
		<td><span id="elh_detail_pendaftaran_id_asisten"><?php echo $detail_pendaftaran->id_asisten->FldCaption() ?></span></td>
...
<?php echo $detail_pendaftaran->id_asisten->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($detail_pendaftaran->status_kelompok->Visible) { // status_kelompok ?>
	<tr id="r_status_kelompok">
		<td><span id="elh_detail_pendaftaran_status_kelompok"><?php echo $detail_pendaftaran->status_kelompok->FldCaption() ?></span></td>
...
<?php if ($detail_pendaftaran->nilai_akhir->Visible) { // nilai_akhir ?>
	<tr id="r_nilai_akhir">
		<td><span id="elh_detail_pendaftaran_nilai_akhir"><?php echo $detail_pendaftaran->nilai_akhir->FldCaption() ?></span></td>
...
<?php echo $detail_pendaftaran->nilai_akhir->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($detail_pendaftaran->persetujuan->Visible) { // persetujuan ?>
	<tr id="r_persetujuan">
		<td><span id="elh_detail_pendaftaran_persetujuan"><?php echo $detail_pendaftaran->persetujuan->FldCaption() ?></span></td>
...
<?php echo $detail_pendaftaran->persetujuan->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php if ($detail_pendaftaran->Export == "") { ?>
<script type="text/javascript">
fdetail_pendaftaranview.Init();
</script>
<?php } ?>
<?php
$detail_pendaftaran_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<?php if ($detail_pendaftaran->Export == "") { ?>
...
<?php
$detail_pendaftaran_view->Page_Terminate();
?>
