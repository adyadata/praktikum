...
class cuser_list extends cuser {
	...
	function GetFilterList() {
		...
		if (EW_SEARCH_FILTER_OPTION == "Server") {
			$sSavedFilterList = $UserProfile->GetSearchFilters(CurrentUserName(), "fuserlistsrch");
		} else {
			$sSavedFilterList = "";
		}
	...
	function AdvancedSearchWhere($Default = FALSE) {
		...
		$this->BuildSearchSql($sWhere, $this->nim, $Default, FALSE); // nim
		...
		$this->BuildSearchSql($sWhere, $this->level, $Default, FALSE); // level
	...
	function SetUpSortOrder() {
		...
		if (@$_GET["order"] <> "") {
			...
			$this->UpdateSort($this->id_user, $bCtrl); // id_user
	...
	function RenderListOptions() {
		...
		$oListOpt->Body = "<input type=\"checkbox\" name=\"key_m[]\" value=\"" . ew_HtmlEncode($this->id_user->CurrentValue) . "\" onclick='ew_ClickMultiCheckbox(event);'>";
	...
	function LoadSearchValues() {
		...
		// nim
		$this->nim->AdvancedSearch->SearchValue = ew_StripSlashes(@$_GET["x_nim"]);
		if ($this->nim->AdvancedSearch->SearchValue <> "") $this->Command = "search";
		$this->nim->AdvancedSearch->SearchOperator = @$_GET["z_nim"];
		...
		// level
		$this->level->AdvancedSearch->SearchValue = ew_StripSlashes(@$_GET["x_level"]);
		if ($this->level->AdvancedSearch->SearchValue <> "") $this->Command = "search";
		$this->level->AdvancedSearch->SearchOperator = @$_GET["z_level"];
	}
	...
	function RenderRow() {
		...
		$this->level->ViewCustomAttributes = "";
			...
			$this->nim->EditValue = ew_HtmlEncode($this->nim->AdvancedSearch->SearchValue);
	...
	function ExportQueryString() {
		...
		$this->AddSearchQueryString($sQry, $this->nim); // nim
		...
		$this->AddSearchQueryString($sQry, $this->level); // level
...
fuserlist.Lists["x_level"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fuserlist.Lists["x_level"].Options = <?php echo json_encode($user->level->Options()) ?>;
...
// Dynamic selection lists
fuserlistsrch.Lists["x_level"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fuserlistsrch.Lists["x_level"].Options = <?php echo json_encode($user->level->Options()) ?>;
</script>
<script type="text/javascript">
...
<?php if ($user->level->Visible) { // level ?>
	<div id="xsc_level" class="ewCell form-group">
		<label class="ewSearchCaption ewLabel"><?php echo $user->level->FldCaption() ?></label>
		<span class="ewSearchOperator"><?php echo $Language->Phrase("=") ?><input type="hidden" name="z_level" id="z_level" value="="></span>
...
<div class="panel panel-default ewGrid user">
<?php if ($user->Export == "") { ?>
...
<?php } ?>
<?php if ($user_list->TotalRecs > 0 && (!EW_AUTO_HIDE_PAGE_SIZE_SELECTOR || $user_list->Pager->Visible)) { ?>
<div class="ewPager">
<input type="hidden" name="t" value="user">
...
<option value="200"<?php if ($user_list->DisplayRecs == 200) { ?> selected<?php } ?>>200</option>
...
<?php if ($user->id_user->Visible) { // id_user ?>
	<?php if ($user->SortUrl($user->id_user) == "") { ?>
		<th data-name="id_user"><div id="elh_user_id_user" class="user_id_user"><div class="ewTableHeaderCaption"><?php echo $user->id_user->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="id_user"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $user->SortUrl($user->id_user) ?>',2);"><div id="elh_user_id_user" class="user_id_user">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $user->id_user->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($user->id_user->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($user->id_user->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
<?php if ($user->nim->Visible) { // nim ?>
	<?php if ($user->SortUrl($user->nim) == "") { ?>
		<th data-name="nim"><div id="elh_user_nim" class="user_nim"><div class="ewTableHeaderCaption"><?php echo $user->nim->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="nim"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $user->SortUrl($user->nim) ?>',2);"><div id="elh_user_nim" class="user_nim">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $user->nim->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ewTableHeaderSort"><?php if ($user->nim->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($user->nim->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
<?php if ($user->nama->Visible) { // nama ?>
	<?php if ($user->SortUrl($user->nama) == "") { ?>
		<th data-name="nama"><div id="elh_user_nama" class="user_nama"><div class="ewTableHeaderCaption"><?php echo $user->nama->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="nama"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $user->SortUrl($user->nama) ?>',2);"><div id="elh_user_nama" class="user_nama">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $user->nama->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ewTableHeaderSort"><?php if ($user->nama->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($user->nama->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
<?php if ($user->username->Visible) { // username ?>
	...
	<?php } else { ?>
		<th data-name="username"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $user->SortUrl($user->username) ?>',2);"><div id="elh_user_username" class="user_username">
...
<?php if ($user->password->Visible) { // password ?>
	...
	<?php } else { ?>
		<th data-name="password"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $user->SortUrl($user->password) ?>',2);"><div id="elh_user_password" class="user_password">
...
<?php } ?>		
<?php if ($user->level->Visible) { // level ?>
	<?php if ($user->SortUrl($user->level) == "") { ?>
		<th data-name="level"><div id="elh_user_level" class="user_level"><div class="ewTableHeaderCaption"><?php echo $user->level->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="level"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $user->SortUrl($user->level) ?>',2);"><div id="elh_user_level" class="user_level">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $user->level->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($user->level->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($user->level->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
<?php
...
?>
	<?php if ($user->id_user->Visible) { // id_user ?>
		<td data-name="id_user"<?php echo $user->id_user->CellAttributes() ?>>
<span id="el<?php echo $user_list->RowCnt ?>_user_id_user" class="user_id_user">
...
<a id="<?php echo $user_list->PageObjName . "_row_" . $user_list->RowCnt ?>"></a></td>
	<?php } ?>
	<?php if ($user->nim->Visible) { // nim ?>
		<td data-name="nim"<?php echo $user->nim->CellAttributes() ?>>
<span id="el<?php echo $user_list->RowCnt ?>_user_nim" class="user_nim">
<span<?php echo $user->nim->ViewAttributes() ?>>
<?php echo $user->nim->ListViewValue() ?></span>
</span>
</td>
	<?php } ?>
	<?php if ($user->nama->Visible) { // nama ?>
		<td data-name="nama"<?php echo $user->nama->CellAttributes() ?>>
<span id="el<?php echo $user_list->RowCnt ?>_user_nama" class="user_nama">
<span<?php echo $user->nama->ViewAttributes() ?>>
<?php echo $user->nama->ListViewValue() ?></span>
</span>
</td>
	<?php } ?>
	<?php if ($user->username->Visible) { // username ?>
...
<?php echo $user->password->ListViewValue() ?></span>
	...
	<?php } ?>
	<?php if ($user->level->Visible) { // level ?>
		<td data-name="level"<?php echo $user->level->CellAttributes() ?>>
<span id="el<?php echo $user_list->RowCnt ?>_user_level" class="user_level">
<span<?php echo $user->level->ViewAttributes() ?>>
<?php echo $user->level->ListViewValue() ?></span>
</span>
</td>
	<?php } ?>
<?php
