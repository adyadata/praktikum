...
$master_asisten_pengajar_edit = NULL; // Initialize page object first

class cmaster_asisten_pengajar_edit extends cmaster_asisten_pengajar {
	...
	// Page object name
	var $PageObjName = 'master_asisten_pengajar_edit';
...
// Create page object
if (!isset($master_asisten_pengajar_edit)) $master_asisten_pengajar_edit = new cmaster_asisten_pengajar_edit();

// Page init
$master_asisten_pengajar_edit->Page_Init();

// Page main
$master_asisten_pengajar_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$master_asisten_pengajar_edit->Page_Render();
?>
...
var CurrentForm = fmaster_asisten_pengajaredit = new ew_Form("fmaster_asisten_pengajaredit", "edit");

// Validate form
fmaster_asisten_pengajaredit.Validate = function() {
...
fmaster_asisten_pengajaredit.Form_CustomValidate = 
...
fmaster_asisten_pengajaredit.ValidateRequired = true;
<?php } else { ?>
fmaster_asisten_pengajaredit.ValidateRequired = false; 
<?php } ?>
...
<?php if (!$master_asisten_pengajar_edit->IsModal) { ?>
<div class="ewToolbar">
...
<?php } ?>
<?php $master_asisten_pengajar_edit->ShowPageHeader(); ?>
<?php
$master_asisten_pengajar_edit->ShowMessage();
?>
<?php if (!$master_asisten_pengajar_edit->IsModal) { ?>
<form name="ewPagerForm" class="form-horizontal ewForm ewPagerForm" action="<?php echo ew_CurrentPage() ?>">
<?php if (!isset($master_asisten_pengajar_edit->Pager)) $master_asisten_pengajar_edit->Pager = new cPrevNextPager($master_asisten_pengajar_edit->StartRec, $master_asisten_pengajar_edit->DisplayRecs, $master_asisten_pengajar_edit->TotalRecs) ?>
<?php if ($master_asisten_pengajar_edit->Pager->RecordCount > 0 && $master_asisten_pengajar_edit->Pager->Visible) { ?>
<div class="ewPager">
<span><?php echo $Language->Phrase("Page") ?>&nbsp;</span>
<div class="ewPrevNext"><div class="input-group">
<div class="input-group-btn">
<!--first page button-->
	<?php if ($master_asisten_pengajar_edit->Pager->FirstButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerFirst") ?>" href="<?php echo $master_asisten_pengajar_edit->PageUrl() ?>start=<?php echo $master_asisten_pengajar_edit->Pager->FirstButton->Start ?>"><span class="icon-first ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerFirst") ?>"><span class="icon-first ewIcon"></span></a>
	<?php } ?>
<!--previous page button-->
	<?php if ($master_asisten_pengajar_edit->Pager->PrevButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerPrevious") ?>" href="<?php echo $master_asisten_pengajar_edit->PageUrl() ?>start=<?php echo $master_asisten_pengajar_edit->Pager->PrevButton->Start ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerPrevious") ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } ?>
</div>
<!--current page number-->
	<input class="form-control input-sm" type="text" name="<?php echo EW_TABLE_PAGE_NO ?>" value="<?php echo $master_asisten_pengajar_edit->Pager->CurrentPage ?>">
<div class="input-group-btn">
<!--next page button-->
	<?php if ($master_asisten_pengajar_edit->Pager->NextButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerNext") ?>" href="<?php echo $master_asisten_pengajar_edit->PageUrl() ?>start=<?php echo $master_asisten_pengajar_edit->Pager->NextButton->Start ?>"><span class="icon-next ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerNext") ?>"><span class="icon-next ewIcon"></span></a>
	<?php } ?>
<!--last page button-->
	<?php if ($master_asisten_pengajar_edit->Pager->LastButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerLast") ?>" href="<?php echo $master_asisten_pengajar_edit->PageUrl() ?>start=<?php echo $master_asisten_pengajar_edit->Pager->LastButton->Start ?>"><span class="icon-last ewIcon"></span></a>
	<?php } else { ?>
...
<span>&nbsp;<?php echo $Language->Phrase("of") ?>&nbsp;<?php echo $master_asisten_pengajar_edit->Pager->PageCount ?></span>
</div>
<?php } ?>
<div class="clearfix"></div>
</form>
<?php } ?>
<form name="fmaster_asisten_pengajaredit" id="fmaster_asisten_pengajaredit" class="<?php echo $master_asisten_pengajar_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($master_asisten_pengajar_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $master_asisten_pengajar_edit->Token ?>">
<?php } ?>
...
<input type="hidden" data-table="master_asisten_pengajar" data-field="x_kode_asisten" name="x_kode_asisten" id="x_kode_asisten" value="<?php echo ew_HtmlEncode($master_asisten_pengajar->kode_asisten->CurrentValue) ?>">
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $master_asisten_pengajar_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div>
</div>
<?php if (!isset($master_asisten_pengajar_edit->Pager)) $master_asisten_pengajar_edit->Pager = new cPrevNextPager($master_asisten_pengajar_edit->StartRec, $master_asisten_pengajar_edit->DisplayRecs, $master_asisten_pengajar_edit->TotalRecs) ?>
<?php if ($master_asisten_pengajar_edit->Pager->RecordCount > 0 && $master_asisten_pengajar_edit->Pager->Visible) { ?>
...
<script type="text/javascript">
fmaster_asisten_pengajaredit.Init();
</script>
<?php
$master_asisten_pengajar_edit->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$master_asisten_pengajar_edit->Page_Terminate();
?>
