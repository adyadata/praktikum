...
class cuserpriv extends ct_03_userlevels {
	...
	function __construct() {
		...
		if (!isset($GLOBALS["t_03_userlevels"])) $GLOBALS["t_03_userlevels"] = &$this;
	...
	function Page_Init() {
		...
		$Security->LoadCurrentUserLevel(CurrentProjectID() . 't_03_userlevels');
	...
	function Page_Main() {
		...
		$Breadcrumb->Add("list", "t_03_userlevels", "t_03_userlevelslist.php", "", "t_03_userlevels");
...
<p><?php echo $Language->Phrase("UserLevel") ?><?php echo $Security->GetUserLevelName($t_03_userlevels->userlevelid->CurrentValue) ?>(<?php echo $t_03_userlevels->userlevelid->CurrentValue ?>)</p>
<?php
...
<input type="hidden" name="x_userlevelid" id="x_userlevelid" value="<?php echo $t_03_userlevels->userlevelid->CurrentValue ?>">
...
for ($i = 0; $i < $userpriv->TableNameCount; $i++) {
	$userpriv->TempPriv = $Security->GetUserLevelPrivEx($userpriv->TableList[$i][4] . $userpriv->TableList[$i][0], $t_03_userlevels->userlevelid->CurrentValue);
