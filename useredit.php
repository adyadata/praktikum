...
fuseredit.Lists["x_level"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fuseredit.Lists["x_level"].Options = <?php echo json_encode($user->level->Options()) ?>;
...
<?php if (!isset($user_edit->Pager)) $user_edit->Pager = new cPrevNextPager($user_edit->StartRec, $user_edit->DisplayRecs, $user_edit->TotalRecs) ?>
...
<!--first page button-->
	...
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerFirst") ?>" href="<?php echo $user_edit->PageUrl() ?>start=<?php echo $user_edit->Pager->FirstButton->Start ?>"><span class="icon-first ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerFirst") ?>"><span class="icon-first ewIcon"></span></a>
	<?php } ?>
<!--previous page button-->
	<?php if ($user_edit->Pager->PrevButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerPrevious") ?>" href="<?php echo $user_edit->PageUrl() ?>start=<?php echo $user_edit->Pager->PrevButton->Start ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerPrevious") ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } ?>
</div>
<!--current page number-->
	<input class="form-control input-sm" type="text" name="<?php echo EW_TABLE_PAGE_NO ?>" value="<?php echo $user_edit->Pager->CurrentPage ?>">
<div class="input-group-btn">
<!--next page button-->
	<?php if ($user_edit->Pager->NextButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerNext") ?>" href="<?php echo $user_edit->PageUrl() ?>start=<?php echo $user_edit->Pager->NextButton->Start ?>"><span class="icon-next ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerNext") ?>"><span class="icon-next ewIcon"></span></a>
	<?php } ?>
<!--last page button-->
	<?php if ($user_edit->Pager->LastButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerLast") ?>" href="<?php echo $user_edit->PageUrl() ?>start=<?php echo $user_edit->Pager->LastButton->Start ?>"><span class="icon-last ewIcon"></span></a>
	<?php } else { ?>
...
<span>&nbsp;<?php echo $Language->Phrase("of") ?>&nbsp;<?php echo $user_edit->Pager->PageCount ?></span>
</div>
<?php } ?>
<div class="clearfix"></div>
</form>
...
<?php if ($user->id_user->Visible) { // id_user ?>
	<div id="r_id_user" class="form-group">
		<label id="elh_user_id_user" class="col-sm-2 control-label ewLabel"><?php echo $user->id_user->FldCaption() ?></label>
		<div class="col-sm-10"><div<?php echo $user->id_user->CellAttributes() ?>>
<span id="el_user_id_user">
<span<?php echo $user->id_user->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $user->id_user->EditValue ?></p></span>
</span>
<input type="hidden" data-table="user" data-field="x_id_user" name="x_id_user" id="x_id_user" value="<?php echo ew_HtmlEncode($user->id_user->CurrentValue) ?>">
<?php echo $user->id_user->CustomMsg ?></div></div>
	</div>
<?php } ?>
