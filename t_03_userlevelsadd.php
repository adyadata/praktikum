...
$t_03_userlevels_add = NULL; // Initialize page object first

class ct_03_userlevels_add extends ct_03_userlevels {
	...
	// Page object name
	var $PageObjName = 't_03_userlevels_add';
		...
		switch ($this->CurrentAction) {
			...
			case "C": // Copy an existing record
				if (!$this->LoadRow()) { // Load record based on key
					...
					$this->Page_Terminate("t_03_userlevelslist.php"); // No matching record, return to list
				}
				break;
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "t_03_userlevelsview.php")
...
// Create page object
if (!isset($t_03_userlevels_add)) $t_03_userlevels_add = new ct_03_userlevels_add();

// Page init
$t_03_userlevels_add->Page_Init();

// Page main
$t_03_userlevels_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$t_03_userlevels_add->Page_Render();
?>
...
var CurrentForm = ft_03_userlevelsadd = new ew_Form("ft_03_userlevelsadd", "add");

// Validate form
ft_03_userlevelsadd.Validate = function() {
...
ft_03_userlevelsadd.Form_CustomValidate = 
...
ft_03_userlevelsadd.ValidateRequired = true;
<?php } else { ?>
ft_03_userlevelsadd.ValidateRequired = false; 
<?php } ?>
...
<?php if (!$t_03_userlevels_add->IsModal) { ?>
<div class="ewToolbar">
...
<?php } ?>
<?php $t_03_userlevels_add->ShowPageHeader(); ?>
<?php
$t_03_userlevels_add->ShowMessage();
?>
<form name="ft_03_userlevelsadd" id="ft_03_userlevelsadd" class="<?php echo $t_03_userlevels_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($t_03_userlevels_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $t_03_userlevels_add->Token ?>">
<?php } ?>
...
<input type="text" data-table="t_03_userlevels" data-field="x_userlevelid" name="x_userlevelid" id="x_userlevelid" size="30" placeholder="<?php echo ew_HtmlEncode($t_03_userlevels->userlevelid->getPlaceHolder()) ?>" value="<?php echo $t_03_userlevels->userlevelid->EditValue ?>"<?php echo $t_03_userlevels->userlevelid->EditAttributes() ?>>
</span>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $t_03_userlevels_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div>
</div>
<?php } ?>
</form>
<script type="text/javascript">
ft_03_userlevelsadd.Init();
</script>
<?php
$t_03_userlevels_add->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$t_03_userlevels_add->Page_Terminate();
?>
