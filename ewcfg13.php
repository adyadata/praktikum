...
define("EW_PROJECT_NAME", "praktikum", TRUE); // Project name
...
define("EW_RANDOM_KEY", 'FVh9t57pd5t20Tgu', TRUE); // Random key for encryption
...
$EW_CONN["DB"] = array("conn" => NULL, "id" => "DB", "type" => "MYSQL", "host" => "localhost", "port" => 3306, "user" => "root", "pass" => "admin", "db" => "sim_praktikum", "qs" => "`", "qe" => "`");
...
define("EW_AUDIT_TRAIL_TABLE_NAME", "t_01_audit_trail", TRUE); // Audit trail table name
define("EW_AUDIT_TRAIL_TABLE_VAR", "t_01_audit_trail", TRUE); // Audit trail table var
...
@define("EW_USER_LEVEL_TABLE", "`t_03_userlevels`", TRUE);
...
@define("EW_USER_LEVEL_PRIV_TABLE", "`t_04_userlevelpermissions`", TRUE);
...
define("EW_USER_TABLE", "`t_02_user`", TRUE);
