...
fuserdelete.Lists["x_level"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fuserdelete.Lists["x_level"].Options = <?php echo json_encode($user->level->Options()) ?>;
...
<?php if ($user->id_user->Visible) { // id_user ?>
		<th><span id="elh_user_id_user" class="user_id_user"><?php echo $user->id_user->FldCaption() ?></span></th>
<?php } ?>
<?php if ($user->nim->Visible) { // nim ?>
		<th><span id="elh_user_nim" class="user_nim"><?php echo $user->nim->FldCaption() ?></span></th>
<?php } ?>
<?php if ($user->nama->Visible) { // nama ?>
		<th><span id="elh_user_nama" class="user_nama"><?php echo $user->nama->FldCaption() ?></span></th>
<?php } ?>
...
<?php if ($user->level->Visible) { // level ?>
		<th><span id="elh_user_level" class="user_level"><?php echo $user->level->FldCaption() ?></span></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>
...
<?php if ($user->id_user->Visible) { // id_user ?>
		<td<?php echo $user->id_user->CellAttributes() ?>>
<span id="el<?php echo $user_delete->RowCnt ?>_user_id_user" class="user_id_user">
...
<?php } ?>
<?php if ($user->nim->Visible) { // nim ?>
		<td<?php echo $user->nim->CellAttributes() ?>>
<span id="el<?php echo $user_delete->RowCnt ?>_user_nim" class="user_nim">
...
<?php } ?>
<?php if ($user->nama->Visible) { // nama ?>
		<td<?php echo $user->nama->CellAttributes() ?>>
<span id="el<?php echo $user_delete->RowCnt ?>_user_nama" class="user_nama">
...
<span id="el<?php echo $user_delete->RowCnt ?>_user_level" class="user_level">
