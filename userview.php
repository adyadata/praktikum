				...
				case "I": // Get a record to display
					...
					if ($this->TotalRecs <= 0) { // No record found
						...
						while (!$this->Recordset->EOF) {
							if (strval($this->id_user->CurrentValue) == strval($this->Recordset->fields('id_user'))) {
...
fuserview.Lists["x_level"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fuserview.Lists["x_level"].Options = <?php echo json_encode($user->level->Options()) ?>;
...
<?php if (!isset($user_view->Pager)) $user_view->Pager = new cPrevNextPager($user_view->StartRec, $user_view->DisplayRecs, $user_view->TotalRecs) ?>
...
<!--first page button-->
	...
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerFirst") ?>" href="<?php echo $user_view->PageUrl() ?>start=<?php echo $user_view->Pager->FirstButton->Start ?>"><span class="icon-first ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerFirst") ?>"><span class="icon-first ewIcon"></span></a>
	<?php } ?>
<!--previous page button-->
	<?php if ($user_view->Pager->PrevButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerPrevious") ?>" href="<?php echo $user_view->PageUrl() ?>start=<?php echo $user_view->Pager->PrevButton->Start ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerPrevious") ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } ?>
</div>
<!--current page number-->
	<input class="form-control input-sm" type="text" name="<?php echo EW_TABLE_PAGE_NO ?>" value="<?php echo $user_view->Pager->CurrentPage ?>">
<div class="input-group-btn">
<!--next page button-->
	<?php if ($user_view->Pager->NextButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerNext") ?>" href="<?php echo $user_view->PageUrl() ?>start=<?php echo $user_view->Pager->NextButton->Start ?>"><span class="icon-next ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerNext") ?>"><span class="icon-next ewIcon"></span></a>
	<?php } ?>
<!--last page button-->
	<?php if ($user_view->Pager->LastButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerLast") ?>" href="<?php echo $user_view->PageUrl() ?>start=<?php echo $user_view->Pager->LastButton->Start ?>"><span class="icon-last ewIcon"></span></a>
	<?php } else { ?>
...
<span>&nbsp;<?php echo $Language->Phrase("of") ?>&nbsp;<?php echo $user_view->Pager->PageCount ?></span>
</div>
<?php } ?>
<div class="clearfix"></div>
</form>
...
<?php if ($user->id_user->Visible) { // id_user ?>
	<tr id="r_id_user">
		<td><span id="elh_user_id_user"><?php echo $user->id_user->FldCaption() ?></span></td>
...
<?php if ($user->nim->Visible) { // nim ?>
	<tr id="r_nim">
		<td><span id="elh_user_nim"><?php echo $user->nim->FldCaption() ?></span></td>
		<td data-name="nim"<?php echo $user->nim->CellAttributes() ?>>
<span id="el_user_nim">
<span<?php echo $user->nim->ViewAttributes() ?>>
<?php echo $user->nim->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
