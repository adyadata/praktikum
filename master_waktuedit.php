...
$master_waktu_edit = NULL; // Initialize page object first

class cmaster_waktu_edit extends cmaster_waktu {
	...
	// Page object name
	var $PageObjName = 'master_waktu_edit';
	...
	function Page_Main() {
		...
		if (@$_GET["id_waktu"] <> "") {
			...
			$this->RecKey["id_waktu"] = $this->id_waktu->QueryStringValue;
		} else {
		...
		if ($this->TotalRecs <= 0) { // No record found
			...
			$this->Page_Terminate("master_waktulist.php"); // Return to list page
			...
			while (!$this->Recordset->EOF) {
				if (strval($this->id_waktu->CurrentValue) == strval($this->Recordset->fields('id_waktu'))) {
...
// Create page object
if (!isset($master_waktu_edit)) $master_waktu_edit = new cmaster_waktu_edit();

// Page init
$master_waktu_edit->Page_Init();

// Page main
$master_waktu_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$master_waktu_edit->Page_Render();
?>
...
var CurrentForm = fmaster_waktuedit = new ew_Form("fmaster_waktuedit", "edit");

// Validate form
fmaster_waktuedit.Validate = function() {
...
fmaster_waktuedit.Form_CustomValidate = 
...
fmaster_waktuedit.ValidateRequired = true;
<?php } else { ?>
fmaster_waktuedit.ValidateRequired = false; 
<?php } ?>
...
<?php if (!$master_waktu_edit->IsModal) { ?>
<div class="ewToolbar">
...
<?php } ?>
<?php $master_waktu_edit->ShowPageHeader(); ?>
<?php
$master_waktu_edit->ShowMessage();
?>
<?php if (!$master_waktu_edit->IsModal) { ?>
<form name="ewPagerForm" class="form-horizontal ewForm ewPagerForm" action="<?php echo ew_CurrentPage() ?>">
<?php if (!isset($master_waktu_edit->Pager)) $master_waktu_edit->Pager = new cPrevNextPager($master_waktu_edit->StartRec, $master_waktu_edit->DisplayRecs, $master_waktu_edit->TotalRecs) ?>
<?php if ($master_waktu_edit->Pager->RecordCount > 0 && $master_waktu_edit->Pager->Visible) { ?>
<div class="ewPager">
<span><?php echo $Language->Phrase("Page") ?>&nbsp;</span>
<div class="ewPrevNext"><div class="input-group">
<div class="input-group-btn">
<!--first page button-->
	<?php if ($master_waktu_edit->Pager->FirstButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerFirst") ?>" href="<?php echo $master_waktu_edit->PageUrl() ?>start=<?php echo $master_waktu_edit->Pager->FirstButton->Start ?>"><span class="icon-first ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerFirst") ?>"><span class="icon-first ewIcon"></span></a>
	<?php } ?>
<!--previous page button-->
	<?php if ($master_waktu_edit->Pager->PrevButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerPrevious") ?>" href="<?php echo $master_waktu_edit->PageUrl() ?>start=<?php echo $master_waktu_edit->Pager->PrevButton->Start ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerPrevious") ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } ?>
</div>
<!--current page number-->
	<input class="form-control input-sm" type="text" name="<?php echo EW_TABLE_PAGE_NO ?>" value="<?php echo $master_waktu_edit->Pager->CurrentPage ?>">
<div class="input-group-btn">
<!--next page button-->
	<?php if ($master_waktu_edit->Pager->NextButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerNext") ?>" href="<?php echo $master_waktu_edit->PageUrl() ?>start=<?php echo $master_waktu_edit->Pager->NextButton->Start ?>"><span class="icon-next ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerNext") ?>"><span class="icon-next ewIcon"></span></a>
	<?php } ?>
<!--last page button-->
	<?php if ($master_waktu_edit->Pager->LastButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerLast") ?>" href="<?php echo $master_waktu_edit->PageUrl() ?>start=<?php echo $master_waktu_edit->Pager->LastButton->Start ?>"><span class="icon-last ewIcon"></span></a>
	<?php } else { ?>
...
<span>&nbsp;<?php echo $Language->Phrase("of") ?>&nbsp;<?php echo $master_waktu_edit->Pager->PageCount ?></span>
</div>
<?php } ?>
<div class="clearfix"></div>
</form>
<?php } ?>
<form name="fmaster_waktuedit" id="fmaster_waktuedit" class="<?php echo $master_waktu_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($master_waktu_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $master_waktu_edit->Token ?>">
<?php } ?>
...
<?php if ($master_waktu->id_waktu->Visible) { // id_waktu ?>
	<div id="r_id_waktu" class="form-group">
		<label id="elh_master_waktu_id_waktu" class="col-sm-2 control-label ewLabel"><?php echo $master_waktu->id_waktu->FldCaption() ?></label>
		<div class="col-sm-10"><div<?php echo $master_waktu->id_waktu->CellAttributes() ?>>
<span id="el_master_waktu_id_waktu">
...
<input type="hidden" data-table="master_waktu" data-field="x_id_waktu" name="x_id_waktu" id="x_id_waktu" value="<?php echo ew_HtmlEncode($master_waktu->id_waktu->CurrentValue) ?>">
<?php echo $master_waktu->id_waktu->CustomMsg ?></div></div>
	</div>
<?php } ?>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $master_waktu_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div>
</div>
<?php if (!isset($master_waktu_edit->Pager)) $master_waktu_edit->Pager = new cPrevNextPager($master_waktu_edit->StartRec, $master_waktu_edit->DisplayRecs, $master_waktu_edit->TotalRecs) ?>
<?php if ($master_waktu_edit->Pager->RecordCount > 0 && $master_waktu_edit->Pager->Visible) { ?>
...
<script type="text/javascript">
fmaster_waktuedit.Init();
</script>
<?php
$master_waktu_edit->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$master_waktu_edit->Page_Terminate();
?>
