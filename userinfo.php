...
class cuser extends cTable {
	...
	function __construct() {
		...
		// id_user
		$this->id_user = new cField('user', 'user', 'x_id_user', 'id_user', '`id_user`', '`id_user`', 3, -1, FALSE, '`id_user`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// nim
		$this->nim = new cField('user', 'user', 'x_nim', 'nim', '`nim`', '`nim`', 200, -1, FALSE, '`nim`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->nim->Sortable = TRUE; // Allow sort
		$this->fields['nim'] = &$this->nim;

		// nama
		$this->nama = new cField('user', 'user', 'x_nama', 'nama', '`nama`', '`nama`', 200, -1, FALSE, '`nama`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// level
		$this->level = new cField('user', 'user', 'x_level', 'level', '`level`', '`level`', 202, -1, FALSE, '`level`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'RADIO');
	...
	function GetRecordKeys() {
		...
		if (isset($_POST["key_m"])) {
			...
			if ($isPost && isset($_POST["id_user"]))
				$arKeys[] = ew_StripSlashes($_POST["id_user"]);
			elseif (isset($_GET["id_user"]))
				$arKeys[] = ew_StripSlashes($_GET["id_user"]);
			else
