...
$t_03_userlevels_edit = NULL; // Initialize page object first

class ct_03_userlevels_edit extends ct_03_userlevels {
	...
	// Page object name
	var $PageObjName = 't_03_userlevels_edit';
	...
	function Page_Main() {
		...
		if ($this->TotalRecs <= 0) { // No record found
			...
			$this->Page_Terminate("t_03_userlevelslist.php"); // Return to list page
		...
		switch ($this->CurrentAction) {
			...
			Case "U": // Update
				...
				if (ew_GetPageName($sReturnUrl) == "t_03_userlevelslist.php")
	...
	function SetupBreadcrumb() {
		...
		$Breadcrumb->Add("list", $this->TableVar, $this->AddMasterUrl("t_03_userlevelslist.php"), "", $this->TableVar, TRUE);
		$PageId = "edit";
...
// Create page object
if (!isset($t_03_userlevels_edit)) $t_03_userlevels_edit = new ct_03_userlevels_edit();

// Page init
$t_03_userlevels_edit->Page_Init();

// Page main
$t_03_userlevels_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$t_03_userlevels_edit->Page_Render();
?>
...
var CurrentForm = ft_03_userlevelsedit = new ew_Form("ft_03_userlevelsedit", "edit");

// Validate form
ft_03_userlevelsedit.Validate = function() {
...
ft_03_userlevelsedit.Form_CustomValidate = 
...
ft_03_userlevelsedit.ValidateRequired = true;
<?php } else { ?>
ft_03_userlevelsedit.ValidateRequired = false; 
<?php } ?>
...
<?php if (!$t_03_userlevels_edit->IsModal) { ?>
<div class="ewToolbar">
...
<?php } ?>
<?php $t_03_userlevels_edit->ShowPageHeader(); ?>
<?php
$t_03_userlevels_edit->ShowMessage();
?>
<?php if (!$t_03_userlevels_edit->IsModal) { ?>
<form name="ewPagerForm" class="form-horizontal ewForm ewPagerForm" action="<?php echo ew_CurrentPage() ?>">
<?php if (!isset($t_03_userlevels_edit->Pager)) $t_03_userlevels_edit->Pager = new cPrevNextPager($t_03_userlevels_edit->StartRec, $t_03_userlevels_edit->DisplayRecs, $t_03_userlevels_edit->TotalRecs) ?>
<?php if ($t_03_userlevels_edit->Pager->RecordCount > 0 && $t_03_userlevels_edit->Pager->Visible) { ?>
<div class="ewPager">
<span><?php echo $Language->Phrase("Page") ?>&nbsp;</span>
<div class="ewPrevNext"><div class="input-group">
<div class="input-group-btn">
<!--first page button-->
	<?php if ($t_03_userlevels_edit->Pager->FirstButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerFirst") ?>" href="<?php echo $t_03_userlevels_edit->PageUrl() ?>start=<?php echo $t_03_userlevels_edit->Pager->FirstButton->Start ?>"><span class="icon-first ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerFirst") ?>"><span class="icon-first ewIcon"></span></a>
	<?php } ?>
<!--previous page button-->
	<?php if ($t_03_userlevels_edit->Pager->PrevButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerPrevious") ?>" href="<?php echo $t_03_userlevels_edit->PageUrl() ?>start=<?php echo $t_03_userlevels_edit->Pager->PrevButton->Start ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerPrevious") ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } ?>
</div>
<!--current page number-->
	<input class="form-control input-sm" type="text" name="<?php echo EW_TABLE_PAGE_NO ?>" value="<?php echo $t_03_userlevels_edit->Pager->CurrentPage ?>">
<div class="input-group-btn">
<!--next page button-->
	<?php if ($t_03_userlevels_edit->Pager->NextButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerNext") ?>" href="<?php echo $t_03_userlevels_edit->PageUrl() ?>start=<?php echo $t_03_userlevels_edit->Pager->NextButton->Start ?>"><span class="icon-next ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerNext") ?>"><span class="icon-next ewIcon"></span></a>
	<?php } ?>
<!--last page button-->
	<?php if ($t_03_userlevels_edit->Pager->LastButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerLast") ?>" href="<?php echo $t_03_userlevels_edit->PageUrl() ?>start=<?php echo $t_03_userlevels_edit->Pager->LastButton->Start ?>"><span class="icon-last ewIcon"></span></a>
	<?php } else { ?>
...
<span>&nbsp;<?php echo $Language->Phrase("of") ?>&nbsp;<?php echo $t_03_userlevels_edit->Pager->PageCount ?></span>
</div>
<?php } ?>
<div class="clearfix"></div>
</form>
<?php } ?>
<form name="ft_03_userlevelsedit" id="ft_03_userlevelsedit" class="<?php echo $t_03_userlevels_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($t_03_userlevels_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $t_03_userlevels_edit->Token ?>">
<?php } ?>
...
<?php if ($t_03_userlevels->userlevelid->Visible) { // userlevelid ?>
	<div id="r_userlevelid" class="form-group">
		<label id="elh_t_03_userlevels_userlevelid" for="x_userlevelid" class="col-sm-2 control-label ewLabel"><?php echo $t_03_userlevels->userlevelid->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="col-sm-10"><div<?php echo $t_03_userlevels->userlevelid->CellAttributes() ?>>
<span id="el_t_03_userlevels_userlevelid">
...
<input type="hidden" data-table="t_03_userlevels" data-field="x_userlevelid" name="x_userlevelid" id="x_userlevelid" value="<?php echo ew_HtmlEncode($t_03_userlevels->userlevelid->CurrentValue) ?>">
<?php echo $t_03_userlevels->userlevelid->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($t_03_userlevels->userlevelname->Visible) { // userlevelname ?>
	<div id="r_userlevelname" class="form-group">
		<label id="elh_t_03_userlevels_userlevelname" for="x_userlevelname" class="col-sm-2 control-label ewLabel"><?php echo $t_03_userlevels->userlevelname->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="col-sm-10"><div<?php echo $t_03_userlevels->userlevelname->CellAttributes() ?>>
<span id="el_t_03_userlevels_userlevelname">
<input type="text" data-table="t_03_userlevels" data-field="x_userlevelname" name="x_userlevelname" id="x_userlevelname" size="30" maxlength="255" placeholder="<?php echo ew_HtmlEncode($t_03_userlevels->userlevelname->getPlaceHolder()) ?>" value="<?php echo $t_03_userlevels->userlevelname->EditValue ?>"<?php echo $t_03_userlevels->userlevelname->EditAttributes() ?>>
</span>
<?php echo $t_03_userlevels->userlevelname->CustomMsg ?></div></div>
	</div>
<?php } ?>
</div>
<?php if (!$t_03_userlevels_edit->IsModal) { ?>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $t_03_userlevels_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div>
</div>
<?php if (!isset($t_03_userlevels_edit->Pager)) $t_03_userlevels_edit->Pager = new cPrevNextPager($t_03_userlevels_edit->StartRec, $t_03_userlevels_edit->DisplayRecs, $t_03_userlevels_edit->TotalRecs) ?>
<?php if ($t_03_userlevels_edit->Pager->RecordCount > 0 && $t_03_userlevels_edit->Pager->Visible) { ?>
...
<script type="text/javascript">
ft_03_userlevelsedit.Init();
</script>
<?php
$t_03_userlevels_edit->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$t_03_userlevels_edit->Page_Terminate();
?>
