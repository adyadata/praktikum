...
$t_03_userlevels = NULL;

//
// Table class for t_03_userlevels
//
class ct_03_userlevels extends cTable {
	...
	function __construct() {
		...
		$this->TableVar = 't_03_userlevels';
		$this->TableName = 't_03_userlevels';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`t_03_userlevels`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// userlevelid
		$this->userlevelid = new cField('t_03_userlevels', 't_03_userlevels', 'x_userlevelid', 'userlevelid', '`userlevelid`', '`userlevelid`', 3, -1, FALSE, '`userlevelid`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// userlevelname
		$this->userlevelname = new cField('t_03_userlevels', 't_03_userlevels', 'x_userlevelname', 'userlevelname', '`userlevelname`', '`userlevelname`', 200, -1, FALSE, '`userlevelname`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`t_03_userlevels`";
	}
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "t_03_userlevelslist.php";
		}
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("t_03_userlevelsview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("t_03_userlevelsview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "t_03_userlevelsadd.php?" . $this->UrlParm($parm);
		else
			$url = "t_03_userlevelsadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("t_03_userlevelsedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("t_03_userlevelsadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("t_03_userlevelsdelete.php", $this->UrlParm());
	}
